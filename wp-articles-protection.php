...
*/
function wpap_options() {
?>
<div class="wrap">
<h2>Articles Protection Options</h2>
...
<td>
<input type="radio" name="wpap_enable" value="1" <?=get_option('wpap_enable')==1?" checked=\"checked\"":""?>>Yes
<input type="radio" name="wpap_enable" value="0" <?=(int)get_option('wpap_enable')==0?" checked=\"checked\"":""?>>No
</td>
</tr>

<tr valign="top">
<th scope="row">Support Me:</th>
<td>
<input type="radio" name="wpap_supportme" value="1" <?=(get_option('wpap_supportme')==1 or get_option('wpap_supportme')=='')?" checked=\"checked\"":""?>>Yes(Give askie a link!)
<input type="radio" name="wpap_supportme" value="0" <?=(int)get_option('wpap_supportme')==0?" checked=\"checked\"":""?>>No
</td>
</tr>
...
<input type="hidden" name="page_options" value="wpap_enable,wpap_supportme" />
...
function wpap_menu() {
  add_options_page('Articles Protection', 'Articles Protection', 8, __FILE__, 'wpap_options');
}
...
function wpap_init()
{
	if (get_option('wpap_supportme')==1) 
	{
		$link=array(
